 ...
 *
 * Modified to include a crosshairColor option by Iiii_I_I_I
 */
...
Dygraph.Plugins.Crosshair = (function() {
  ...
  var crosshair = function(opt_options) {
    ...
    this.crosshairColor_ = opt_options.crosshairColor || null;
  };
  ...
  crosshair.prototype.select = function(e) {
    ...
    if (typeof this.crosshairColor_ !== "undefined") {
        ctx.strokeStyle = this.crosshairColor_;
    } else {
