...
- [Scripts for getting the relevant content onto your new wiki](https://meta.weirdgloop.org/w/Leaving_Fandom#Moving_wiki_content)
- [Some Fandom-specific stuff you’re going to want to convert or remove](https://meta.weirdgloop.org/w/Leaving_Fandom/moving_checklist)
- [Advice for announcing the move on Reddit, with some examples](https://meta.weirdgloop.org/w/Leaving_Fandom/effective_Reddit_posts)
- [Advice for working with the game developers and other important people in the community](https://meta.weirdgloop.org/w/Leaving_Fandom/coalition_building)
...
If you’re a wiki editor, go check it out! Even if you’re not a wiki editor, we have a section with [some advice](https://meta.weirdgloop.org/w/Leaving_Fandom/what_to_do_if_you%27re_not_an_editor) for how you can still help get the ball rolling for your favorite wiki.

## Nearly everyone is gonna be rooting for the new wiki. Go build a coalition!

As we’ve helped more wikis get from the “idea stage” to actually launching and announcing the move away from Fandom, I've noticed a consistent gap in expectations, where the wiki admins think moving-from-Fandom is basically internal “hobby drama” that only affects editors, and nobody else will care. Naturally, this means they’re caught off guard when the move gets a huge amount of interest - [10k upvotes on Reddit](https://reddit.com/r/Warframe/comments/1iemokz/the_warframe_wiki_is_officially_moving_from/) with 99% support, [YouTube videos with 4 million views](https://www.youtube.com/watch?v=qcfuA_UAz3I), [mainstream gaming press](https://kotaku.com/gta-wiki-leaving-fandom-rules-censorship-ads-videos-ditching-2000679115) - by far the most attention the wiki’s ever gotten.
...
- Marketers freak out about how their core audience is getting bombarded with ads for games that directly compete with them (the developer of RuneScape had a [fansite program](https://runescape.wiki/w/Fansite?oldid=10212589#Requirements_and_benefits) circa 2013, that gave fansites special access to stuff if they agreed to not run ads for other video games, which, we learned years later, was mostly aimed at freezing out the Fandom wiki that was constantly running ads for WoW, etc)
...
There’s a lot of great videos from established YouTubers that focus on a wiki leaving Fandom. [This one about Hollow Knight](https://www.youtube.com/watch?v=qcfuA_UAz3I) is probably the most well-known, but there’s some popular ones from a [few](https://www.youtube.com/watch?v=ySXP4hxFNFw) [Minecraft](https://www.youtube.com/shorts/DPqa0C4DqeE) [people](https://www.youtube.com/watch?v=T6FdYNyIaUI), [League](https://www.youtube.com/watch?v=KATj_UQu9DY) people, and more. These are one of the main ways that casual wiki readers find out about the move, so you should be doing everything you can to get popular video makers for your game to help spread the word.
...
![Collage of search results for Weird Gloop wikis](/images/posts/google_search_collage.png){:width="650"}{:style="display: block; margin: auto;"}

### Your wiki (and community) are gonna get way better
I noted in 2024 that every wiki we’d moved from Fandom [ended up doubling the number people actively editing](https://weirdgloop.org/blog/why-were-helping-more-wikis-move-away-from-fandom#why-ditching-fandom-is-cool-and-based). In the 2 years since then, that pattern has not only held up, it’s gotten even bigger: **on average, the rate of new editors on a wiki [triples when they move away from Fandom](https://docs.google.com/spreadsheets/d/1liBtY4biPNWIbeCB9MicN9i8VKTSAQRL/edit?usp=sharing&ouid=101068541543340005104&rtpof=true&sd=true)**. That’s three times as many people to help with game updates, work on new projects…everything, really. More contributors makes everything easier.

Moving away from Fandom also gives you a ton of new technical flexibility to implement cool shit - integrations that let you [look things up from the game](https://minecraft.wiki/w/Minecraft_Wiki:Hey_Wiki), [sync your in-game progress](https://oldschool.runescape.wiki/w/RuneScape:WikiSync) to the the wiki…so many examples like this that the readers *love*, and that are just impossible to imagine happening on a Fandom wiki. Not to mention that once you get the game developer involved in the wiki and trusting the wiki editors, there are usually some very obvious areas for collaboration (like sharing game data, or pre-release access, or even just being open to answering questions) that will make the wiki massively better.

---

Go check out [the guide](https://meta.weirdgloop.org/w/Leaving_Fandom)! It’s got a ton of detailed, useful stuff I haven’t talked about here. If you’ve checked it out and want moving advice that’s specific to your situation, we just opened up the [Weird Gloop discord](https://weirdgloop.org/discord), so come say hi there, or [contact me another way](https://weirdgloop.org/contact/).
