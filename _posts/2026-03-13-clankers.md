...
---
![Graph of estimated AI scraper requests per month](/images/posts/clankers_graph1.png){:width="350"}{:class="float-right"} Bots are currently scraping the internet for LLM training data at unprecedented rates[[1]](https://thelibre.news/foss-infrastructure-is-under-attack-by-ai-companies/)[[2]](https://www.glamelab.org/products/are-ai-bots-knocking-cultural-heritage-offline/)[[3]](https://www.theverge.com/column/885244/smart-tv-web-crawler-ai), driving up costs and destabilizing public-facing websites. I want to talk about how **this has been particularly difficult for wikis**, and has gotten much worse in the last few months.
<!--excerpt-->
